...
public class EliminarPaciente extends JInternalFrame {
	...
	public EliminarPaciente() {
		...
		lblEliminarPaciente.setFont(new Font("Tahoma", Font.BOLD, 18));
			...
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						.addComponent(lblEliminarPaciente, GroupLayout.DEFAULT_SIZE, 459, Short.MAX_VALUE)
	...
	private void sendData() {
		...
		if(checkData()) {
			try {
				this.pw.println("REMOVEPACIENTE " + this.textFieldID.getText());
				pw.flush();
			}
			catch(Exception t) {
